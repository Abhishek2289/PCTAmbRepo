...
public class TestingOR extends TestingORHelper
{
	...
	public void testMain(Object[] args) 
	{
		...
		boolean k = powerChartOrganizerForRaoMo(ANY,DISABLED).exists();
		...
		if(k==true)
		{
			...
			powerChartOrganizerForRaoMo(ANY,DISABLED).clickDisabled();
		...
		patientSearchTextBoxtext().click(atPoint(40,4));
		        ...
		        powerChartOrganizerForRaoMo().inputChars(dpString("PatientName"));
		        powerChartOrganizerForRaoMo().inputKeys("{ENTER}"); 
